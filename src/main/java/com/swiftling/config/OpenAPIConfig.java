...
public class OpenAPIConfig {
    ...
    public OpenAPIConfig(KeycloakProperties keycloakProperties) {
    ...
    private Info getInfo() {
        return new Info()
                .title("SwiftLing User API Doc")
                .description("API documentation for SwiftLing Apps User Service Operations")
                .version("v1.0.0");
    }
